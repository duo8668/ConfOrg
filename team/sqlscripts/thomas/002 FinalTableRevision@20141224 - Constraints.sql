...
-- ----------------------------
ALTER TABLE `equipment` ADD CONSTRAINT `fk_Equipment_Category1` FOREIGN KEY (`Category_ID`) REFERENCES `category` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- ----------------------------
ALTER TABLE `room` ADD CONSTRAINT `fk_Room_Venue` FOREIGN KEY (`Venue_ID`) REFERENCES `venue` (`ID`);
