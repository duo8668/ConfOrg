                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="submission/create">All Submission</a>
                                </li>
                                <li>
                                    <a href="#">Add New Submission</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-comment fa-fw"></i> Submission Reviews <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="submission/create">Submitted Reviews</a>
                                </li>
                                <li>
                                    <a href="#">Add New Review</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
